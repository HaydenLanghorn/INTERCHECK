package com.applicantByRefrence;
 ...
 */
public class PoliceCheckByRef {
    public static void main(String [ ] args)
    {
        final  String apiEndPoint =  "https://secure.policecheckexpress.com.au/pce/api/policeCheck/reference";
        final  String apiToken =  "secureToken";
        final  int refNo =11111;
        try {
            ApplicantPoliceCheck applicantPoliceCheck = readJsonFromUrl(apiEndPoint,apiToken,refNo);
    ...
    public static ApplicantPoliceCheck readJsonFromUrl(String api,String token,int refNo) throws IOException {

        final String  url= api+"?token="+token+"&refno="+refNo;
